...
& $exe --headless --path "$WS\test_project" --export-release "Web" "$WS\test_project\export\web\index.html" 2>&1 | Select-String "Export|deploy|assembl|mono|Mono" | Select-Object -First 20
