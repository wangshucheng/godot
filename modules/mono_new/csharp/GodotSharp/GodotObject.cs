...
namespace Godot
{
    ...
    // P2-11: 与 Godot 4.7 core/os/keyboard.h 对齐。
    // - 值域：低 21 位为可打印字符（Unicode），高 11 位为 SPECIAL 标记 + 子码。
    // - Special = 1 << 22 = 0x400000，仅作掩码常量，本身不是有效按键。
    // - 数字键用 Key0..Key9（C# 标识符不能以数字开头），与 Godot 的 KEY_0..KEY_9 对应。
    // - Delete 在 Godot 中写作 KEY_DELETE（Windows 头文件 #define DELETE 冲突），C# 无此问题。
    public enum Key : long
    {
        None = 0,
        Special = 1 << 22, // 0x400000，SPECIAL 标记位，不是有效按键

        // Special keys (SPECIAL | n).
        Escape = Special | 0x01,
        Tab = Special | 0x02,
        ...
        F1 = Special | 0x1C, F2 = Special | 0x1D, F3 = Special | 0x1E, F4 = Special | 0x1F,
        F5 = Special | 0x20, F6 = Special | 0x21, F7 = Special | 0x22, F8 = Special | 0x23,
        F9 = Special | 0x24, F10 = Special | 0x25, F11 = Special | 0x26, F12 = Special | 0x27,
        F13 = Special | 0x28, F14 = Special | 0x29, F15 = Special | 0x2A, F16 = Special | 0x2B,
        F17 = Special | 0x2C, F18 = Special | 0x2D, F19 = Special | 0x2E, F20 = Special | 0x2F,
        F21 = Special | 0x30, F22 = Special | 0x31, F23 = Special | 0x32, F24 = Special | 0x33,
        F25 = Special | 0x34, F26 = Special | 0x35, F27 = Special | 0x36, F28 = Special | 0x37,
        F29 = Special | 0x38, F30 = Special | 0x39, F31 = Special | 0x3A, F32 = Special | 0x3B,
        F33 = Special | 0x3C, F34 = Special | 0x3D, F35 = Special | 0x3E,
        Menu = Special | 0x42,
        Hyper = Special | 0x43,
        Help = Special | 0x45,
        Back = Special | 0x48,
        ...
        Launch0 = Special | 0x60, Launch1 = Special | 0x61, Launch2 = Special | 0x62,
        Launch3 = Special | 0x63, Launch4 = Special | 0x64, Launch5 = Special | 0x65,
        Launch6 = Special | 0x66, Launch7 = Special | 0x67, Launch8 = Special | 0x68,
        Launch9 = Special | 0x69,
        LaunchA = Special | 0x6A, LaunchB = Special | 0x6B, LaunchC = Special | 0x6C,
        LaunchD = Special | 0x6D, LaunchE = Special | 0x6E, LaunchF = Special | 0x6F,
        Globe = Special | 0x70,
        ...
        // Numpad keys (SPECIAL | 0x8x | 0x9).
        KpMultiply = Special | 0x81,
        KpDivide = Special | 0x82,
        KpSubtract = Special | 0x83,
        KpPeriod = Special | 0x84,
        KpAdd = Special | 0x85,
        Kp0 = Special | 0x86, Kp1 = Special | 0x87, Kp2 = Special | 0x88, Kp3 = Special | 0x89,
        Kp4 = Special | 0x8A, Kp5 = Special | 0x8B, Kp6 = Special | 0x8C, Kp7 = Special | 0x8D,
        Kp8 = Special | 0x8E, Kp9 = Special | 0x8F,
