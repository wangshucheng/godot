...
Get-ChildItem "$WS\godot4_7_mono\bin\GodotSharp.dll" -ErrorAction SilentlyContinue | Select-Object Name, Length, LastWriteTime
...
Write-Host "=== Project assemblies ==="
Get-ChildItem "$WS\test_project\.mono\assemblies" | Select-Object Name, Length, LastWriteTime
